import {Aggregate, ExcelExport, Filter, Grid, GridModel, Page, Resize, Toolbar} from "@syncfusion/ej2-grids";
...
export class WxGrid1 extends WxGrid {
    ...
    protected async createGridModel() {
        ...
        let ej = this.gridModel; // super.createGridModel() has already set this.gridModel to this.args.ej
