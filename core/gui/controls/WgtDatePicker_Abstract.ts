import {DatePicker, DatePickerModel, ChangedEventArgs} from '@syncfusion/ej2-calendars';
...
export class Args_WgtDatePicker extends Args_WgtSimple<DatePickerModel> {
...
export abstract class WgtDatePicker_Abstract extends WgtSimple<DatePicker, Args_WgtSimple, Date> {
   ...
   } // initialize_WgtDatePicker_Abstract
   ...
   async localLogicImplementation() {
      ...
      this.obj = new DatePicker(args.ej, this.hgetInput);
