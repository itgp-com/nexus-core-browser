...
export abstract class AbstractDropDownDB<ARG_CLASS extends Args_AbstractDropDownDB = Args_AbstractDropDownDB> extends AbstractDropDown<ARG_CLASS> {
   ...
   /**
    * Allows extending classes to execute code before the super method is called, but after the code in the {@link #initialize_AbstractDropDownDB} method has run
    * @param args
    */
   ...
   /**
    * Allows extending classes to execute code right after the call to <pre>super.initialize_DropDown(args);</pre> in  {@link #initialize_AbstractDropDownDB} method has run
    * @param args
    */
