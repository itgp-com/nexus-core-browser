...
export interface StateN2DlgCloseIconRef extends StateN2HtmlRef{
    widget ?: N2DlgCloseIcon;
}
export interface StateN2DlgCloseIcon extends StateN2Html {
    dialog: N2Dlg;
     ...
     */
    ref ?:StateN2DlgCloseIconRef;
}

export class N2DlgCloseIcon<STATE extends StateN2DlgCloseIcon = any> extends N2Html<STATE> {
    static readonly CLASS_IDENTIFIER: string = 'N2DlgCloseIcon';
    ...
    protected onStateInitialized(state: STATE) {
        addN2Class(state.deco, N2DlgCloseIcon.CLASS_IDENTIFIER);
        if (state.value == null) {
            state.value = `
<span style='margin-right:5px;'>
        <i class='fa-solid fa-circle-xmark' style='font-weight:900;font-size:20px;color: var(--app-dialog-header-font-color) !important;'></i>
</span>`;
        }
