...
export interface StateN2DialogCloseIconRef extends StateN2HtmlRef{
    widget ?: N2DialogCloseIcon;
}
export interface StateN2DialogCloseIcon extends StateN2Html {
    dialog: N2Dialog;
     ...
     */
    ref ?:StateN2DialogCloseIconRef;
}

export class N2DialogCloseIcon<STATE extends StateN2DialogCloseIcon = any> extends N2Html<STATE> {
...
<span id='${state.tagId}'  style='margin-right:5px;'>
    <button type='button' style='background-color: ${css_N2Dialog_color_header_background}'>
        <i class='fa-solid fa-circle-xmark' style='font-weight:900;font-size:20px;color: ${css_N2Dialog_color_header_font} !important;'></i>
    </button>
</span>`;
        }
