...
export interface StateNx2Card extends StateNx2Basic {
 ...
 */
export class Nx2EjCard<STATE extends StateNx2Card = StateNx2Card> extends Nx2Basic<STATE> {
   ...
   private _header_title :Nx2Panel;
    ...
    constructor(state ?: STATE) {
        super(state);
        addNx2Class(this.state.deco, 'Nx2EjCard');
    }



    onStateInitialized(state: STATE) {
        addNx2Class(state.deco, 'e-card');
