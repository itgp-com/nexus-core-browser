...
export interface StateN2AccumulationChartRef extends StateNx2EjBasicRef {
    widget?: N2AccumulationChart;
}

export interface StateN2AccumulationChart<WIDGET_LIBRARY_MODEL extends AccumulationChartModel = AccumulationChartModel> extends StateNx2EjBasic<WIDGET_LIBRARY_MODEL> {
    /**
...
export class N2AccumulationChart<STATE extends StateN2AccumulationChart = StateN2AccumulationChart> extends Nx2EjBasic<STATE, AccumulationChart> {
    static readonly CLASS_IDENTIFIER:string = "N2AccumulationChart"
    constructor(state ?: STATE) {
        super(state);
        addNx2Class(this.state.deco,  N2AccumulationChart.CLASS_IDENTIFIER);
    }
