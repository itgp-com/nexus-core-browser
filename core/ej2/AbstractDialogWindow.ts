...
import {IDialogWindow}         from "../gui/dialog/IDialogWindow";
...
export class AbstractDialogWindow<ARGS_TYPE extends Args_AbstractDialogWindow = Args_AbstractDialogWindow> implements IDialogWindow {
